...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_38701_39600_V1";
const FILE = "src/index.ts";
const START = 38701;
const END = 39600;
const EXPECTED_SHA256 = "a4b318fb07e6180d35bac1fbe1197a9453bf52162e9e227038383ef0953fbbaa";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 409;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_38701_39600_V1_VISIBLE";
