...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_44101_45000_V1";
const FILE = "src/index.ts";
const START = 44101;
const END = 45000;
const EXPECTED_SHA256 = "1da560d707663f513aa0e8b07ee07eb362015fb1c7bed98cef34fec03ec10dcc";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 298;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_44101_45000_V1_VISIBLE";
