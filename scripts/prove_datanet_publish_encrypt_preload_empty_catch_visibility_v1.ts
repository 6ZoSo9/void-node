...
const baselinePath = "docs/security/datanet-publish-encrypt-preload-empty-catch-visibility-v1-baseline.json";
...
console.log(`VOID_DATANET_PUBLISH_ENCRYPT_PRELOAD_EMPTY_CATCH_VISIBILITY_V1_SHA256=${sha}`);
console.log(`VOID_DATANET_PUBLISH_ENCRYPT_PRELOAD_EMPTY_CATCH_VISIBILITY_V1_REAL_EMPTY_CATCH_COUNT=${realEmptyCatchCount}`);
console.log(`VOID_DATANET_PUBLISH_ENCRYPT_PRELOAD_EMPTY_CATCH_VISIBILITY_V1_MARKER_COUNT=${markerCount}`);
...
console.log("VOID_DATANET_PUBLISH_ENCRYPT_PRELOAD_EMPTY_CATCH_VISIBILITY_V1_GREEN");
