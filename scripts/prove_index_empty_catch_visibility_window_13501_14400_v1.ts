...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_13501_14400_V1";
const FILE = "src/index.ts";
const START = 13501;
const END = 14400;
const EXPECTED_SHA256 = "890e59d6468aa9ebf98320ffa83f29da8a5ee187ab2b2dfe01280f86a88801bc";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 1002;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_13501_14400_V1_VISIBLE";
