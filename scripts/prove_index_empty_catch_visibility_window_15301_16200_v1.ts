...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_15301_16200_V1";
const FILE = "src/index.ts";
const START = 15301;
const END = 16200;
const EXPECTED_SHA256 = "b3ec7e54fcc3f6e50be4d7bf8a3304eaf9bc5a70e95f07fa18a50b87fc922727";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 986;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_15301_16200_V1_VISIBLE";
