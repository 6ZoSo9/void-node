...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_18001_18900_V1";
const FILE = "src/index.ts";
const START = 18001;
const END = 18900;
const EXPECTED_SHA256 = "5e299223b432bd9bfd11819e0990aabe64b226f4e6d9c9631c76dd12d07913e8";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 941;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_18001_18900_V1_VISIBLE";
