...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_20701_21600_V1";
const FILE = "src/index.ts";
const START = 20701;
const END = 21600;
const EXPECTED_SHA256 = "0cdfb2b3c4270c244e943250e69b84e1c429b28d9377afcde461ae9f8cd74326";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 890;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_20701_21600_V1_VISIBLE";
