...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_31501_32400_V1";
const FILE = "src/index.ts";
const START = 31501;
const END = 32400;
const EXPECTED_SHA256 = "6d979bafcfb2e07205cfa419efee426ac6a1189bc46ba2c2e59d211d944b8a93";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 605;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_31501_32400_V1_VISIBLE";
