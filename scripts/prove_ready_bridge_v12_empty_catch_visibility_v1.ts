...
const baselinePath = "docs/security/ready-bridge-v12-empty-catch-visibility-v1-baseline.json";
...
console.log(`VOID_READY_BRIDGE_V12_EMPTY_CATCH_VISIBILITY_V1_SHA256=${sha}`);
console.log(`VOID_READY_BRIDGE_V12_EMPTY_CATCH_VISIBILITY_V1_REAL_EMPTY_CATCH_COUNT=${realEmptyCatchCount}`);
console.log(`VOID_READY_BRIDGE_V12_EMPTY_CATCH_VISIBILITY_V1_MARKER_COUNT=${markerCount}`);
...
console.log("VOID_READY_BRIDGE_V12_EMPTY_CATCH_VISIBILITY_V1_GREEN");
