...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_35101_36000_V1";
const FILE = "src/index.ts";
const START = 35101;
const END = 36000;
const EXPECTED_SHA256 = "2b98f7b250adf1da5f999b9fe054ebf6a82c77b1134d4eee3549c55581007370";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 523;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_35101_36000_V1_VISIBLE";
