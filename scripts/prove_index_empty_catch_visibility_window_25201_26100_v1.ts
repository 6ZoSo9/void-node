...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_25201_26100_V1";
const FILE = "src/index.ts";
const START = 25201;
const END = 26100;
const EXPECTED_SHA256 = "d73a516e5e4659cd1f74375c93a571f9f861220aef5952b3c1fb8d69c294c35d";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 784;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_25201_26100_V1_VISIBLE";
