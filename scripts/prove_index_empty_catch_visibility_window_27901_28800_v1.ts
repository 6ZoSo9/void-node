...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_27901_28800_V1";
const FILE = "src/index.ts";
const START = 27901;
const END = 28800;
const EXPECTED_SHA256 = "c5e2b6bfef9e722eb6b2b20691928140f670f0bdd0e94bfb9ec4b9422e878234";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 670;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_27901_28800_V1_VISIBLE";
