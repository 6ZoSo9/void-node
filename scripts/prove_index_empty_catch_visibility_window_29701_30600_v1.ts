...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_29701_30600_V1";
const FILE = "src/index.ts";
const START = 29701;
const END = 30600;
const EXPECTED_SHA256 = "28d28a6cf7364fed7dd3e4214ca58f33e1a9a077c24fd4ea77523f267df4e4dd";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 647;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_29701_30600_V1_VISIBLE";
