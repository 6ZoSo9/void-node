...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_36001_36900_V1";
const FILE = "src/index.ts";
const START = 36001;
const END = 36900;
const EXPECTED_SHA256 = "1daa48d7ccd4748c4c00367acab08a7df4289e3d4a667eb54a67ede75d1943b8";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 501;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_36001_36900_V1_VISIBLE";
