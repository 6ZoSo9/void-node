...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_41401_42300_V1";
const FILE = "src/index.ts";
const START = 41401;
const END = 42300;
const EXPECTED_SHA256 = "6c1e3366f1259361a180472b418b6f8d7fa735d88d979f24bebc0d742bc36b2e";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 356;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_41401_42300_V1_VISIBLE";
