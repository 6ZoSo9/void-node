...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_39601_40500_V1";
const FILE = "src/index.ts";
const START = 39601;
const END = 40500;
const EXPECTED_SHA256 = "263224f8066071ef8c6cda531721e45f95cc76d55a2acb2972fa74d8e7fc3645";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 398;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_39601_40500_V1_VISIBLE";
