...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_12601_13500_V1";
const FILE = "src/index.ts";
const START = 12601;
const END = 13500;
const EXPECTED_SHA256 = "b595fa4b8a58b1711ec9e16882335f7fc70e528259d6d7472960e5c603db4c5e";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 1007;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_12601_13500_V1_VISIBLE";
