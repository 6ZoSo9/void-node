...
const IDENTITY_HEAD = '7e20ea0bfa501434375f610616e1940df99d1d68';
const IDENTITY_FIXTURE_BLOB = '7cc9e7b1db5ffd751acd24d086ae30a873a9a568';
const IDENTITY_DOC_BLOB = '21185a26c0b6fb689866d4aaba2eaac0c3f352b1';
...
async function main() {
  ...
  const dir = await mkdtemp(join(tmpdir(), 'void-bq-context-v3-'));
  try {
