...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_16201_17100_V1";
const FILE = "src/index.ts";
const START = 16201;
const END = 17100;
const EXPECTED_SHA256 = "3ce1fba7e4a8ff514ec2e2e3d98a00d1406aa1a5260c664e61937ab556d7b5f7";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 965;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_16201_17100_V1_VISIBLE";
