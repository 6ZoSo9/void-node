...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_10801_11700_V1";
const FILE = "src/index.ts";
const START = 10801;
const END = 11700;
const EXPECTED_SHA256 = "30a6a7e1368708c26cdd4a0e4cfe9ee0338c8ee44e1f812bf3e044a636b8e04b";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 1017;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_10801_11700_V1_VISIBLE";
