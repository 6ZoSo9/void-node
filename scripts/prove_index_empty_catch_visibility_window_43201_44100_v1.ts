...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_43201_44100_V1";
const FILE = "src/index.ts";
const START = 43201;
const END = 44100;
const EXPECTED_SHA256 = "4e6388ec6aaa0144e56787521b6c8ae697d0aa6747be26017c5eb73b55d75139";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 308;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_43201_44100_V1_VISIBLE";
