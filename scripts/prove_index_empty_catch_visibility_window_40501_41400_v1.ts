...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_40501_41400_V1";
const FILE = "src/index.ts";
const START = 40501;
const END = 41400;
const EXPECTED_SHA256 = "c0a69e4a6c48b1b1b45ce59bc9fee3b5fc6bb87ddcee30a0381db90785f910bc";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 372;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_40501_41400_V1_VISIBLE";
