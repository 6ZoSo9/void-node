...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_34201_35100_V1";
const FILE = "src/index.ts";
const START = 34201;
const END = 35100;
const EXPECTED_SHA256 = "cca65817cb290c40c3e8392ed7e0a615800c5567975172e33c1e010df3c3e3e6";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 546;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_34201_35100_V1_VISIBLE";
