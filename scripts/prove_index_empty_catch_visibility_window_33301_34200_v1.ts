...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_33301_34200_V1";
const FILE = "src/index.ts";
const START = 33301;
const END = 34200;
const EXPECTED_SHA256 = "41ab9f1c4712f5f439cd3b68c885d21e9e20a8be6b3e1c21b679324dab5f7dc5";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 552;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_33301_34200_V1_VISIBLE";
