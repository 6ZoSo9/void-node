...
const verified = verifySigningAuthorizationV1(pending);
...
console.log("canonical_authorization_status=AUTHORIZED_FOR_ONE_FIXED_CREDENTIAL_SIGNATURE_ONLY");
console.log("authorization_id=" + verified.authorization_id);
console.log(
...
console.log("canonical_single_signature_authorization_proven=true");
console.log("credential_access_authorized=true");
console.log("private_key_access_authorized=true");
console.log("transaction_signing_authorized=true");
