...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_42301_43200_V1";
const FILE = "src/index.ts";
const START = 42301;
const END = 43200;
const EXPECTED_SHA256 = "d8f73807863e036ccf0f1647d1eca2f78824106cc40c2a1993c34437079b5cce";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 331;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_42301_43200_V1_VISIBLE";
