...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_18901_19800_V1";
const FILE = "src/index.ts";
const START = 18901;
const END = 19800;
const EXPECTED_SHA256 = "adcfee3aa0f3b0669cc4ad91cf9194f662dcc6981bea5c715be175646a6c851e";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 915;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_18901_19800_V1_VISIBLE";
