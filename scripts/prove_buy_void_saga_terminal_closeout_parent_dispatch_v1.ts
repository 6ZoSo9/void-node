...
assert.equal(
  ...
  "saga_terminal_closeout_runtime_disabled",
);
...
console.log(
  "VOID_BUY_VOID_SAGA_TERMINAL_CLOSEOUT_PARENT_DISPATCH_V1_PROOF_GREEN",
);
console.log("parent_runtime_enable_gate_required=true");
console.log("child_terminal_closeout_runtime_enable_gate_required=true");
console.log("parent_dispatch_to_terminal_closeout_runtime_proven=true");
console.log("invalid_saga_rejected_by_terminal_closeout_child=true");
console.log("inventory_consumption_performed=false");
console.log("public_request_fulfilled=false");
