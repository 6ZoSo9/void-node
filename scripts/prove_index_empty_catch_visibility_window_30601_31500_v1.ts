...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_30601_31500_V1";
const FILE = "src/index.ts";
const START = 30601;
const END = 31500;
const EXPECTED_SHA256 = "f7eace5497abebb311f21a92a36aa836dfc897256b9e614f621a039aedd56b6b";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 632;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_30601_31500_V1_VISIBLE";
