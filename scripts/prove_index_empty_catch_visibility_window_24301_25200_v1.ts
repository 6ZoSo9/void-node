...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_24301_25200_V1";
const FILE = "src/index.ts";
const START = 24301;
const END = 25200;
const EXPECTED_SHA256 = "93fedfe485242503ae4da96b9e8c052af755da9dd15403d0aecd7a859bcf7f1d";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 799;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_24301_25200_V1_VISIBLE";
