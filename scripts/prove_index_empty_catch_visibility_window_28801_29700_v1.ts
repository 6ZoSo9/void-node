...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_28801_29700_V1";
const FILE = "src/index.ts";
const START = 28801;
const END = 29700;
const EXPECTED_SHA256 = "ae5194531d67a2d15294870a8d99b416ecffad3ad1cd5456e0b634af6c0abec8";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 654;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_28801_29700_V1_VISIBLE";
