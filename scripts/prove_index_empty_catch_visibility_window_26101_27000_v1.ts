...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_26101_27000_V1";
const FILE = "src/index.ts";
const START = 26101;
const END = 27000;
const EXPECTED_SHA256 = "38b82bd7f2cad65aa5e0d673d85dc42421cd6ab008273d81b633c55593ccd9ee";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 763;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_26101_27000_V1_VISIBLE";
