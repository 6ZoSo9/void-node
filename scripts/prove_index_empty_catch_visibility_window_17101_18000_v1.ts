...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_17101_18000_V1";
const FILE = "src/index.ts";
const START = 17101;
const END = 18000;
const EXPECTED_SHA256 = "9a04938c42838523dba514161a7cec84e8787a9d451531db58328ed25680cfb3";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 959;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_17101_18000_V1_VISIBLE";
