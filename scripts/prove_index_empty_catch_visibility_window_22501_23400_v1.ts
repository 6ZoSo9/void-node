...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_22501_23400_V1";
const FILE = "src/index.ts";
const START = 22501;
const END = 23400;
const EXPECTED_SHA256 = "5351d9c81aa85d2d594a872dd13a0983c239efa69397eef84ff8bec7e80d85a4";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 854;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_22501_23400_V1_VISIBLE";
