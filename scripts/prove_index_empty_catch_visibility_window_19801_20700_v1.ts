...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_19801_20700_V1";
const FILE = "src/index.ts";
const START = 19801;
const END = 20700;
const EXPECTED_SHA256 = "116f8fec68172bb43cbab4a32a611ca16478324802242be6c1c74387736bab8e";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 898;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_19801_20700_V1_VISIBLE";
