...
assert.equal(Buffer.byteLength(recoveredIndex), 3847315);
assert.equal(sha256(recoveredIndex), "74b6ce6e7a3e3cc0fe87e8f92943a96d35e445cab60dfba506db735f4f49f6bc");
