...
assert.equal(review.comparison.push0_absent_from_creation_executable_bytecode, true);
assert.equal(review.comparison.push0_absent_from_runtime_executable_bytecode, true);
