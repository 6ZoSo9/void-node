...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_37801_38700_V1";
const FILE = "src/index.ts";
const START = 37801;
const END = 38700;
const EXPECTED_SHA256 = "46907f168fa2e335582774b2a8f23a2bab2e3d36b9fede18ebd09e23422481f0";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 431;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_37801_38700_V1_VISIBLE";
