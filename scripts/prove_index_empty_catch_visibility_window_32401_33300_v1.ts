...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_32401_33300_V1";
const FILE = "src/index.ts";
const START = 32401;
const END = 33300;
const EXPECTED_SHA256 = "f0c6facb6ada12039b52359b86e5ac5f83d176488eb93dbcb7da33db72e871b6";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 573;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_32401_33300_V1_VISIBLE";
