...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_21601_22500_V1";
const FILE = "src/index.ts";
const START = 21601;
const END = 22500;
const EXPECTED_SHA256 = "ba706d0f015b4bdf7ea6cf83ca48df84326b951db86eab590fa4f23a232a3b91";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 878;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_21601_22500_V1_VISIBLE";
