...
const ID = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_36901_37800_V1";
const FILE = "src/index.ts";
const START = 36901;
const END = 37800;
const EXPECTED_SHA256 = "c231fc7e641f1a4f05e68be085d7640b1e4fbb50934e461b8eff70246eb6b25e";
const EXPECTED_WINDOW_EMPTY_CATCH_COUNT = 0;
const EXPECTED_TOTAL_EMPTY_CATCH_COUNT = 452;
const EXPECTED_MEASURED_CATCH_CONTEXT_COUNT = 2563;
const MARKER = "VOID_INDEX_EMPTY_CATCH_VISIBILITY_WINDOW_36901_37800_V1_VISIBLE";
