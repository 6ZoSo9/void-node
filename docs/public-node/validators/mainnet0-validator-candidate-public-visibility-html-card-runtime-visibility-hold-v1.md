# Mainnet-0 Validator Candidate Public Visibility HTML Card Runtime Visibility Hold v1
...
This brick records that the static Mainnet-0 validator candidate visibility HTML card is browser-visible through the public node static surface.

It binds:

- HTML card marker: `VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_HTML_CARD_HOLD_V1`
- Source visibility marker: `VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_INDEX_HOLD_V1`
...
This is runtime visibility metadata for a static HTML card only.

It does not enable public validator submit, stake lock, wallet connect, candidate registration, candidate intake, active admission, activation, validator-set writes, validator runtime truth writes, runtime mutation routes, or mutation handlers.
