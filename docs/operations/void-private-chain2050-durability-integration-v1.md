...
The checkpoint minimum and delivery-history proof must therefore be bound to that confirmed receipt, not guessed immediately after submission.
...
10. requires a finalized checkpoint on chain `2050` at or above that block with the exact delivery binding; and
11. append-only records the delivery block number, delivery block hash, checkpoint identity, and successful continuity verification before the active claim can be reused.
...
| satisfaction durable | finalized checkpoint covers the exact confirmed receipt history | yes |
