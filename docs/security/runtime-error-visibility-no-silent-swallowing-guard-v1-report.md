...
- repo_literal_empty_catch_count: 896
...
- [PASS] repo-wide-literal-empty-catch-pressure-recorded: repo literal empty catch count=896, expected>0 as bounded future cleanup inventory
