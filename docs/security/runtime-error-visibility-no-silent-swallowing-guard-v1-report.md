...
- repo_literal_empty_catch_count: 396
...
- [PASS] repo-wide-literal-empty-catch-pressure-recorded: repo literal empty catch count=396, expected>0 as bounded future cleanup inventory
