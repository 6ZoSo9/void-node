...
- repo_literal_empty_catch_count: 0
...
- [PASS] repo-wide-literal-empty-catch-zero: repo literal empty catch count=0, expected=0 after final empty-catch cleanup closure
