...
## First External Tester WC Operator Award Record Runbook Rollup Guard

Marker: VOID_PUBLIC_NODE_FIRST_EXTERNAL_TESTER_WC_OPERATOR_AWARD_RECORD_RUNBOOK_ROLLUP_GUARD_DOC_V1

The live status rollup now guards the operator award record runbook proof.

Rollup mode uses a scratch DATA_DIR inside the rollup output directory. This proves the award-record flow without repeatedly mutating the real live runtime during normal status checks.

Expected live rollup lines:

- first_external_tester_wc_operator_award_record_runbook_green=true
- first_external_tester_wc_operator_award_record_runbook_refusal_guard_green=true
- first_external_tester_wc_operator_award_record_runbook_source_draft_green=true
- first_external_tester_wc_operator_award_record_runbook_source_review_record_green=true
- first_external_tester_wc_operator_award_record_runbook_source_decision_record_green=true
- first_external_tester_wc_operator_award_record_runbook_source_award_intent_packet_green=true
- first_external_tester_wc_operator_award_record_runbook_explicit_confirmation_green=true
- first_external_tester_wc_operator_award_record_runbook_scratch_data_dir_green=true
- first_external_tester_wc_operator_award_record_runbook_local_award_record_written=true
- first_external_tester_wc_operator_award_record_runbook_real_live_runtime_write=false
- first_external_tester_wc_operator_award_record_runbook_award_record_created_now=true
- first_external_tester_wc_operator_award_record_runbook_award_created_now=false
- first_external_tester_wc_operator_award_record_runbook_award_write_allowed_now=false
- first_external_tester_wc_operator_award_record_runbook_wc_ledger_mutated_now=false
- first_external_tester_wc_operator_award_record_runbook_wc_credit_delta_now=0
- first_external_tester_wc_operator_award_record_runbook_proposed_wc_delta_only=true
- first_external_tester_wc_operator_award_record_runbook_ledger_record_created_now=false
- first_external_tester_wc_operator_award_record_runbook_wc_ledger_write=false
- first_external_tester_wc_operator_award_record_runbook_wc_credit_award=false
...
## First External Tester WC Ledger Write Readiness Status Rollup Guard

Marker: VOID_PUBLIC_NODE_FIRST_EXTERNAL_TESTER_WC_LEDGER_WRITE_READINESS_STATUS_ROLLUP_GUARD_DOC_V1

The live status rollup now guards the first external tester WC ledger write readiness status proof.

This is public read-only status only. It confirms the lane remains blocked before any real Work Credit ledger write.

Expected live rollup lines:

- first_external_tester_wc_ledger_write_readiness_status_green=true
- first_external_tester_wc_ledger_write_readiness_status_state=blocked_not_ready_for_ledger_write
- first_external_tester_wc_ledger_write_readiness_ready_for_ledger_write=false
- first_external_tester_wc_ledger_write_readiness_ready_for_credit_award=false
- first_external_tester_wc_ledger_write_readiness_operator_review_record_approved=false
- first_external_tester_wc_ledger_write_readiness_operator_decision_record_approved=false
- first_external_tester_wc_ledger_write_readiness_operator_award_intent_packet_approved=false
- first_external_tester_wc_ledger_write_readiness_operator_award_record_approved=false
- first_external_tester_wc_ledger_write_readiness_operator_ledger_entry_preview_reviewed=false
- first_external_tester_wc_ledger_write_readiness_positive_nonzero_wc_delta_selected_by_operator=false
- first_external_tester_wc_ledger_write_readiness_duplicate_ledger_entry_check_green=false
- first_external_tester_wc_ledger_write_readiness_source_hash_chain_green=false
- first_external_tester_wc_ledger_write_readiness_explicit_operator_ledger_write_confirmation_present=false
- first_external_tester_wc_ledger_write_readiness_ledger_write_runbook_exists=false
- first_external_tester_wc_ledger_write_readiness_ledger_write_runbook_proof_green=false
- first_external_tester_wc_ledger_write_readiness_ledger_write_allowed_now=false
- first_external_tester_wc_ledger_write_readiness_ledger_record_created_now=false
- first_external_tester_wc_ledger_write_readiness_wc_ledger_mutated_now=false
- first_external_tester_wc_ledger_write_readiness_wc_credit_delta_now=0
...
- first_external_tester_wc_source_hash_chain_fixture_preview_length=8
