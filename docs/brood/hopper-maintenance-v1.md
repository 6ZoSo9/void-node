...
Docker targets now receive the same fail-closed treatment. A complete SHA-256
digest is accepted only when the image target is a literal canonical lowercase
