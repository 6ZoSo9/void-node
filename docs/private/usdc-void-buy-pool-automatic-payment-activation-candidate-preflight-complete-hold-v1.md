# USDC/VOID automatic payment activation candidate preflight complete hold v1

Marker: `VOID_USDC_VOID_BUY_POOL_AUTOMATIC_PAYMENT_ACTIVATION_CANDIDATE_PREFLIGHT_COMPLETE_HOLD_V1`

This private/operator-only brick marks the activation candidate preflight chain complete only as a held chain.

This is a preflight complete hold, not activation, not activation release, not execution, and not automatic fulfillment enablement.

Source fixture: `fixtures/private/usdc-void-buy-pool-automatic-payment-activation-candidate-preflight-final-seal-hold-v1.json`
...
- Preflight complete hold is held closed.
...
Next required gate: `activation_candidate_preflight_complete_closeout_hold_v1`
