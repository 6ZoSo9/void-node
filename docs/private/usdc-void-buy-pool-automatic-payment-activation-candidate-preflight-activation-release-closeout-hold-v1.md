# USDC/VOID automatic payment activation candidate preflight activation release closeout hold v1

Marker: `VOID_USDC_VOID_BUY_POOL_AUTOMATIC_PAYMENT_ACTIVATION_CANDIDATE_PREFLIGHT_ACTIVATION_RELEASE_CLOSEOUT_HOLD_V1`

This private/operator-only brick holds the activation release closeout closed after activation release gate hold.

This is an activation release closeout hold, not activation release, not activation closeout, and not activation enablement.

Source fixture: `fixtures/private/usdc-void-buy-pool-automatic-payment-activation-candidate-preflight-activation-release-gate-hold-v1.json`
...
- Activation release closed out: `false`
...
Next required gate: `activation_candidate_preflight_final_rollup_hold_v1`
