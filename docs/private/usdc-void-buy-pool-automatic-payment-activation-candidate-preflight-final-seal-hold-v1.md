# USDC/VOID automatic payment activation candidate preflight final seal hold v1

Marker: `VOID_USDC_VOID_BUY_POOL_AUTOMATIC_PAYMENT_ACTIVATION_CANDIDATE_PREFLIGHT_FINAL_SEAL_HOLD_V1`

This private/operator-only brick seals the activation candidate preflight chain as held closed.

This is a final seal hold, not activation, not activation release, not execution, and not automatic fulfillment enablement.

Source fixture: `fixtures/private/usdc-void-buy-pool-automatic-payment-activation-candidate-preflight-final-rollup-hold-v1.json`
...
- Seal state: `held_closed`
- Preflight chain sealed as hold: `true`
...
- Final seal is held closed.
- The preflight chain is sealed only as a hold chain.
...
Next required gate: `activation_candidate_preflight_complete_hold_v1`
