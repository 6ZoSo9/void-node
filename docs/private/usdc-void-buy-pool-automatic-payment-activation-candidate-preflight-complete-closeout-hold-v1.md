# USDC/VOID automatic payment activation candidate preflight complete closeout hold v1

Marker: `VOID_USDC_VOID_BUY_POOL_AUTOMATIC_PAYMENT_ACTIVATION_CANDIDATE_PREFLIGHT_COMPLETE_CLOSEOUT_HOLD_V1`

This private/operator-only brick marks the activation candidate preflight complete closeout as held closed.

This is a preflight complete closeout hold, not activation, not activation release, not execution, and not automatic fulfillment enablement.

Source fixture: `fixtures/private/usdc-void-buy-pool-automatic-payment-activation-candidate-preflight-complete-hold-v1.json`
...
- Preflight complete closeout hold is held closed.
- The preflight complete closeout is not written.
...
Next required gate: `activation_candidate_preflight_status_rollup_hold_v1`
