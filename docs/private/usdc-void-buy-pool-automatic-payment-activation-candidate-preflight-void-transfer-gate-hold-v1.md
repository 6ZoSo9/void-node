# USDC/VOID automatic payment activation candidate preflight VOID transfer gate hold v1

Marker: `VOID_USDC_VOID_BUY_POOL_AUTOMATIC_PAYMENT_ACTIVATION_CANDIDATE_PREFLIGHT_VOID_TRANSFER_GATE_HOLD_V1`

This private/operator-only brick holds the VOID transfer gate closed after transaction broadcast gate hold.

This is a VOID transfer gate hold, not token transfer and not buyer fulfillment.

Source fixture: `fixtures/private/usdc-void-buy-pool-automatic-payment-activation-candidate-preflight-transaction-broadcast-gate-hold-v1.json`
...
- reason: transaction broadcast gate hold is not VOID transfer authorization

## Gate hold checks

- transaction_broadcast_gate_complete_but_not_void_transfer_authorization
- void_transfer_gate_exists
- void_transfer_gate_held_closed
...
Next required gate: `activation_candidate_preflight_signing_gate_hold_v1`
