# USDC/VOID automatic payment activation candidate preflight source consistency check v1

Marker: `VOID_USDC_VOID_BUY_POOL_AUTOMATIC_PAYMENT_ACTIVATION_CANDIDATE_PREFLIGHT_SOURCE_CONSISTENCY_CHECK_V1`

This private/operator-only brick checks consistency across the verification sources bound by the previous activation preflight source-binding gate.

This is a consistency check, not execution.

Source fixture: `fixtures/private/usdc-void-buy-pool-automatic-payment-activation-candidate-preflight-verification-sources-v1.json`

## Consistency checks

- all_bound_sources_exist
- source_count_matches_bound_count
- payment_verification_sources_present
- identity_duplicate_amount_allowlist_sources_present
- inventory_allocation_fulfillment_sources_present
- signer_authorization_remains_separate
- execution_authorization_remains_separate
...
Next required gate: `activation_candidate_preflight_authority_separation_check_v1`
