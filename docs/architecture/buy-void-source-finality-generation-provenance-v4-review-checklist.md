...
- Runtime source verification must execute before V3 RPC composition.
...
- `source_generation_verified=true` must mean only reviewed source-runtime bytes were verified.
