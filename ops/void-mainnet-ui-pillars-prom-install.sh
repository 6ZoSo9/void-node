...
echo "=== [ui-pillars-prom] backing up Prom config to $BACKUP ==="
sudo tar -czf "$BACKUP" -C "$PROM_DIR" .

echo
echo "=== [ui-pillars-prom] writing ui-pillars rules ==="
...
echo
echo "=== [ui-pillars-prom] writing ui-pillars alerts ==="
...
echo
echo "=== [ui-pillars-prom] promtool check rules ==="
...
echo
echo "=== [ui-pillars-prom] reloading prometheus ==="
