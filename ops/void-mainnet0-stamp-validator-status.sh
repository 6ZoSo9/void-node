...
if ready_ok and same_node is False and local_ok and main_ok and head_gap_abs is not None and head_gap_abs <= 2:
    status = "candidate"
    status_reason = "two-box mainnet0 readiness proof green (bounded live race tolerated)"
