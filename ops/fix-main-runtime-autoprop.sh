...
Environment=VOID_COMMIT_DIRECT_V2FS_EMPTY=1
Environment=VOID_COMMIT_DIRECT_V2FS_AUTO_EMPTY=1
Environment=VOID_COMMIT_DIRECT_V2FS_ALLOW_EMPTY=1
Environment=ALLOW_EMPTY_BLOCKS=1
Environment=VOID_ALLOW_EMPTY=1
Environment=VOID_V2FS_AUTO_EMPTY=1
