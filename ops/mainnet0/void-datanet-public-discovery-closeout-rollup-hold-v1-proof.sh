...
BRICK="datanet-public-discovery-closeout-rollup-hold-v1"
...
assert entry["scope"] == "datanet_public_discovery_closeout_rollup"
assert entry["closeout_rollup_hold_only"] is True
...
assert rollup["schema"] == "void.public_node.datanet.public_discovery_closeout_rollup.v1"
assert rollup["id"] == brick
assert rollup["status"] == "hold"
assert rollup["marker"] == marker
assert rollup["scope"] == "datanet_public_discovery_closeout_rollup"
...
expected = {
    "datanet-public-discovery-onboarding-card-hold-v1": "VOID_DATANET_PUBLIC_DISCOVERY_ONBOARDING_CARD_HOLD_V1_GREEN",
    "datanet-public-discovery-onboarding-runtime-visibility-hold-v1": "VOID_DATANET_PUBLIC_DISCOVERY_ONBOARDING_RUNTIME_VISIBILITY_HOLD_V1_GREEN",
    "root-public-node-datanet-discovery-index-link-hold-v1": "VOID_ROOT_PUBLIC_NODE_DATANET_DISCOVERY_INDEX_LINK_HOLD_V1_GREEN",
    "datanet-public-discovery-final-seal-hold-v1": "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HOLD_V1_GREEN",
    "datanet-public-discovery-final-seal-html-card-hold-v1": "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_HOLD_V1_GREEN",
    "datanet-public-discovery-final-seal-html-card-runtime-visibility-hold-v1": "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1_GREEN",
}
...
print("datanet_public_discovery_closeout_rollup_binding_green=true")
PY

echo "== component proof stack =="
declare -A PROOFS=(
  [VOID_DATANET_PUBLIC_DISCOVERY_ONBOARDING_CARD_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-public-discovery-onboarding-card-hold-v1-proof.sh"
  [VOID_DATANET_PUBLIC_DISCOVERY_ONBOARDING_RUNTIME_VISIBILITY_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-public-discovery-onboarding-runtime-visibility-hold-v1-proof.sh"
  [VOID_ROOT_PUBLIC_NODE_DATANET_DISCOVERY_INDEX_LINK_HOLD_V1_GREEN]="ops/mainnet0/void-root-public-node-datanet-discovery-index-link-hold-v1-proof.sh"
  [VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-public-discovery-final-seal-hold-v1-proof.sh"
  [VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-public-discovery-final-seal-html-card-hold-v1-proof.sh"
  [VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-public-discovery-final-seal-html-card-runtime-visibility-hold-v1-proof.sh"
)
...
paths = [
    ...
    Path("public/public-node/datanet/datanet-public-discovery-closeout-rollup-hold-v1.json"),
    Path("docs/public-node/datanet/datanet-public-discovery-closeout-rollup-hold-v1.md"),
]
...
echo "== result =="
echo "VOID_DATANET_PUBLIC_DISCOVERY_CLOSEOUT_ROLLUP_HOLD_V1_GREEN"
