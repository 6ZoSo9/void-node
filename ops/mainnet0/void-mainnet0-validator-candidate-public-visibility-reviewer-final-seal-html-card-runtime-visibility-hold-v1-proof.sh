...
HTML_BRICK="mainnet0-validator-candidate-public-visibility-reviewer-final-seal-html-card-hold-v1"
HTML_MARKER="VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_REVIEWER_FINAL_SEAL_HTML_CARD_HOLD_V1"
...
assert runtime["source_reviewer_final_seal_route"] == seal_route
assert runtime["html_card_marker"] == html_marker
assert runtime["source_reviewer_final_seal_marker"] == seal_marker
...
print("validator_candidate_public_visibility_reviewer_final_seal_html_runtime_binding_green=true")
PYCHECK
