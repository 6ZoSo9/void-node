...
grep -Fq "expected_route_count=16" ops/mainnet0/public-node-self-check-snapshot-proof.sh
grep -Fq "route_count=16" ops/mainnet0/public-node-route-manifest-proof.sh
...
ok(manifest.route_count === 16, "manifest route count 14");
...
ok(snap.expected_route_count === 16, "self-check route count 14");
