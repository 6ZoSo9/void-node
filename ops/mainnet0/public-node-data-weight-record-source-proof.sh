...
assert "A high rank without the required validator quorum does not create canonical state." in d
assert "Sovereign-reserved chain stop or mutation authority" in d
