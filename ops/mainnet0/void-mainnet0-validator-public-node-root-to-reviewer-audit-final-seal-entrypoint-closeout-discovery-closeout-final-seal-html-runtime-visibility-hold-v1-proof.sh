...
marker = "VOID_MAINNET0_VALIDATOR_PUBLIC_NODE_ROOT_TO_REVIEWER_AUDIT_FINAL_SEAL_ENTRYPOINT_CLOSEOUT_DISCOVERY_CLOSEOUT_FINAL_SEAL_HTML_RUNTIME_VISIBILITY_HOLD_V1"
card_marker = "VOID_MAINNET0_VALIDATOR_PUBLIC_NODE_ROOT_TO_REVIEWER_AUDIT_FINAL_SEAL_ENTRYPOINT_CLOSEOUT_DISCOVERY_CLOSEOUT_FINAL_SEAL_HTML_CARD_HOLD_V1"
...
section_key = "mainnet0_validator_root_to_reviewer_audit_final_seal_entrypoint_closeout_discovery_closeout_final_seal_html_runtime_visibility"

section_index_path = Path("public/public-node/validators/index.json")
runtime_path = Path("public/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-runtime-visibility-hold-v1.json")
doc_path = Path("docs/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-runtime-visibility-hold-v1.md")
proof_path = Path("ops/mainnet0/void-mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-runtime-visibility-hold-v1-proof.sh")

card_html_path = Path("public/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-card-hold-v1.html")
card_json_path = Path("public/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-card-hold-v1.json")
...
runtime_route = "/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-runtime-visibility-hold-v1.json"
card_html_route = "/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-card-hold-v1.html"
card_json_route = "/public-node/validators/mainnet0-validator-public-node-root-to-reviewer-audit-final-seal-entrypoint-closeout-discovery-closeout-final-seal-html-card-hold-v1.json"
...
ensure(runtime.get("source_closeout_final_seal_route") == closeout_seal_route, "runtime closeout seal route mismatch")
ensure(runtime.get("source_closeout_rollup_route") == rollup_route, "runtime rollup route mismatch")
ensure(runtime.get("source_closeout_rollup_html_card_route") == rollup_html_route, "runtime rollup html route mismatch")
ensure(runtime.get("source_closeout_rollup_html_card_json_route") == rollup_html_json_route, "runtime rollup html json route mismatch")
ensure(runtime.get("source_closeout_rollup_html_runtime_visibility_route") == rollup_html_runtime_route, "runtime rollup html runtime route mismatch")
ensure(runtime.get("source_discovery_final_seal_route") == discovery_seal_route, "runtime discovery seal route mismatch")
ensure(runtime.get("source_discovery_final_seal_html_card_route") == discovery_seal_html_route, "runtime discovery seal html route mismatch")
ensure(runtime.get("source_discovery_final_seal_html_card_json_route") == discovery_seal_html_json_route, "runtime discovery seal html json route mismatch")
ensure(runtime.get("source_discovery_final_seal_html_runtime_visibility_route") == discovery_seal_html_runtime_route, "runtime discovery seal html runtime route mismatch")
...
print("validator_public_node_root_to_reviewer_audit_final_seal_entrypoint_closeout_discovery_closeout_final_seal_html_runtime_visibility_binding_green=true")
...
print("== result ==")
print("VOID_MAINNET0_VALIDATOR_PUBLIC_NODE_ROOT_TO_REVIEWER_AUDIT_FINAL_SEAL_ENTRYPOINT_CLOSEOUT_DISCOVERY_CLOSEOUT_FINAL_SEAL_HTML_RUNTIME_VISIBILITY_HOLD_V1_GREEN")
PYPROOF
