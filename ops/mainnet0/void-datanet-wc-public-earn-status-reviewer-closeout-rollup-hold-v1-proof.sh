...
BRICK="datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1"
...
PROOF="ops/mainnet0/void-datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1-proof.sh"
...
marker = "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_CLOSEOUT_ROLLUP_HOLD_V1"
entry_id = "datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1"
...
assert entry["path"] == "/public-node/work-credits/datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1.json"
assert entry["json"] == "datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1.json"
assert entry["lane"] == "work_credits"
assert entry["scope"] == "datanet_wc_public_earn_status_reviewer_closeout_rollup"
...
card = json.loads(Path("public/public-node/work-credits/datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1.json").read_text())
assert card["schema"] == "void.public_node.work_credits.datanet_wc_public_earn_status_reviewer_closeout_rollup_hold.v1"
assert card["id"] == entry_id
assert card["status"] == "hold"
assert card["marker"] == marker
assert card["summary_status"] == "public_earn_status_reviewer_closeout_rollup_only_hold"
...
print("public_earn_status_reviewer_closeout_rollup_binding_green=true")
PY

echo "== component proof stack =="
declare -A PROOFS=(
  [VOID_DATANET_WC_PUBLIC_REVIEW_LANE_ROLLUP_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-wc-public-review-lane-rollup-hold-v1-proof.sh"
  [VOID_DATANET_WC_PUBLIC_EARN_READINESS_SUMMARY_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-wc-public-earn-readiness-summary-hold-v1-proof.sh"
  [VOID_DATANET_WC_AVAILABLE_WORK_PUBLIC_REVIEWER_FINAL_SEAL_HOLD_V1_GREEN]="ops/mainnet0/void-datanet-wc-available-work-public-reviewer-final-seal-hold-v1-proof.sh"
)
...
files = [
    ...
    Path("public/public-node/work-credits/datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1.json"),
    Path("docs/public-node/work-credits/datanet-wc-public-earn-status-reviewer-closeout-rollup-hold-v1.md"),
]
