...
reject_fixed "no compress href single quote" "href='/compress" "$OUT/public-node.html"
reject_fixed "no compress action double quote" 'action="/compress' "$OUT/public-node.html"
reject_fixed "no compress action single quote" "action='/compress" "$OUT/public-node.html"
reject_fixed "no compress fetch single quote" "fetch('/compress" "$OUT/public-node.html"
...
reject_fixed "no archive href single quote" "href='/archive" "$OUT/public-node.html"
reject_fixed "no archive action double quote" 'action="/archive' "$OUT/public-node.html"
reject_fixed "no archive action single quote" "action='/archive" "$OUT/public-node.html"
reject_fixed "no archive fetch single quote" "fetch('/archive" "$OUT/public-node.html"
...
reject_fixed "no delete href single quote" "href='/delete" "$OUT/public-node.html"
reject_fixed "no delete action double quote" 'action="/delete' "$OUT/public-node.html"
reject_fixed "no delete action single quote" "action='/delete" "$OUT/public-node.html"
reject_fixed "no delete fetch single quote" "fetch('/delete" "$OUT/public-node.html"
