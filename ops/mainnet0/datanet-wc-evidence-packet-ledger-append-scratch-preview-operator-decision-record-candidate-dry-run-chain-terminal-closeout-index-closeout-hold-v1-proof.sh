...
LANE="datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-record-candidate-dry-run-chain-terminal-closeout-index-closeout"
MARKER="VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_RECORD_CANDIDATE_DRY_RUN_CHAIN_TERMINAL_CLOSEOUT_INDEX_CLOSEOUT_HOLD_V1"

SRC_LANE="datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-record-candidate-dry-run-chain-terminal-closeout-index"
SRC_MARKER="VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_RECORD_CANDIDATE_DRY_RUN_CHAIN_TERMINAL_CLOSEOUT_INDEX_HOLD_V1"
...
if (data.artifact.status !== 'read_only_terminal_closeout_index_closeout_ready') fail('status mismatch');
...
for (const field of falseFields) {
  if (boundary[field] !== false) fail(`${field} must be false`);
}
...
echo "== terminal closeout index closeout deterministic / binding =="
echo "operator_decision_record_candidate_dry_run_chain_terminal_closeout_index_closeout_deterministic_green=true"
echo "operator_decision_record_candidate_dry_run_chain_terminal_closeout_index_closeout_binding_green=true"
