...
grep -F "public_literal_get_count=161" "$doc" >/dev/null
grep -F "public_literal_get_unique_count=161" "$doc" >/dev/null
...
grep -F "public_literal_get_count=161" /tmp/void-public-safety-index-route-audit.out >/dev/null
grep -F "public_literal_get_unique_count=161" /tmp/void-public-safety-index-route-audit.out >/dev/null
