...
BRICK="mainnet0-validator-public-visibility-root-to-reviewer-chain-audit-final-seal-html-runtime-visibility-hold-v1"
MARKER="VOID_MAINNET0_VALIDATOR_PUBLIC_VISIBILITY_ROOT_TO_REVIEWER_CHAIN_AUDIT_FINAL_SEAL_HTML_RUNTIME_VISIBILITY_HOLD_V1"

CARD_BRICK="mainnet0-validator-public-visibility-root-to-reviewer-chain-audit-final-seal-html-card-hold-v1"
CARD_MARKER="VOID_MAINNET0_VALIDATOR_PUBLIC_VISIBILITY_ROOT_TO_REVIEWER_CHAIN_AUDIT_FINAL_SEAL_HTML_CARD_HOLD_V1"
...
assert runtime["source_final_seal_route"] == seal_route
assert runtime["source_final_seal_marker"] == seal_marker
assert runtime["source_audit_rollup_route"] == audit_route
assert runtime["source_audit_rollup_marker"] == audit_marker
assert runtime["source_audit_html_card_route"] == audit_html_route
assert runtime["source_audit_html_card_json_route"] == audit_html_json_route
assert runtime["source_audit_html_card_marker"] == audit_html_marker
assert runtime["source_audit_html_runtime_visibility_route"] == audit_runtime_route
assert runtime["source_audit_html_runtime_visibility_marker"] == audit_runtime_marker
...
print("validator_public_visibility_root_to_reviewer_chain_audit_final_seal_html_runtime_binding_green=true")
PYCHECK
...
paths = [
    ...
    Path("public/public-node/validators/mainnet0-validator-public-visibility-root-to-reviewer-chain-audit-final-seal-html-runtime-visibility-hold-v1.json"),
]
