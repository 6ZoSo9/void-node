...
BRICK="datanet-wc-review-result-example-hold-v1"
...
PROOF="ops/mainnet0/void-datanet-wc-review-result-example-hold-v1-proof.sh"
...
marker = "VOID_DATANET_WC_REVIEW_RESULT_EXAMPLE_HOLD_V1"
entry_id = "datanet-wc-review-result-example-hold-v1"
...
assert entry["path"] == "/public-node/work-credits/datanet-wc-review-result-example-hold-v1.json"
assert entry["json"] == "datanet-wc-review-result-example-hold-v1.json"
assert entry["lane"] == "work_credits"
assert entry["scope"] == "datanet_review_result_example"
assert entry["example_only"] is True
assert entry["eligible_for_future_wc_action"] is False
...
card = json.loads(Path("public/public-node/work-credits/datanet-wc-review-result-example-hold-v1.json").read_text())
assert card["schema"] == "void.public_node.work_credits.datanet_wc_review_result_example_hold.v1"
...
assert ref["id"] == "datanet-wc-review-result-template-hold-v1"

result = card["example_review_result"]
assert result["result_kind"] == "datanet_wc_review_result"
assert result["result_status"] == "example_only_not_reviewed"
...
print("review_result_example_binding_green=true")
PY
...
files = [
    ...
    Path("public/public-node/work-credits/datanet-wc-review-result-example-hold-v1.json"),
    Path("docs/public-node/work-credits/datanet-wc-review-result-example-hold-v1.md"),
]
