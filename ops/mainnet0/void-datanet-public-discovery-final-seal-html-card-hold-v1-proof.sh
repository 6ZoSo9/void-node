...
BRICK="datanet-public-discovery-final-seal-html-card-hold-v1"
MARKER="VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_HOLD_V1"
...
FINAL_SEAL="public/public-node/datanet/datanet-public-discovery-final-seal-hold-v1.json"
...
assert entry["scope"] == "datanet_public_discovery_final_seal_html_card"
assert entry["browser_visible_final_seal_card"] is True
...
assert meta["schema"] == "void.public_node.datanet.public_discovery_final_seal_html_card.v1"
...
assert meta["final_seal_json"] == "/public-node/datanet/datanet-public-discovery-final-seal-hold-v1.json"
...
assert components["final_seal_json"].endswith("datanet-public-discovery-final-seal-hold-v1.json")
...
for expected in [
    "VOID DataNet Public Discovery Final Seal",
...
print("datanet_public_discovery_final_seal_html_card_binding_green=true")
PY

echo "== component proof stack =="
bash ops/mainnet0/void-datanet-public-discovery-final-seal-hold-v1-proof.sh >/tmp/void-datanet-final-seal-html-card-final-seal-proof.log
grep -F "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HOLD_V1_GREEN" /tmp/void-datanet-final-seal-html-card-final-seal-proof.log >/dev/null
...
paths = [
    ...
    Path("public/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.json"),
    Path("public/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.html"),
    Path("docs/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.md"),
]
...
echo "== result =="
echo "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_HOLD_V1_GREEN"
