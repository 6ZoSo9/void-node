...
MARKER="VOID_DATANET_CORE_PEER_PIN_LANE_CLOSEOUT_CAPSULE_PROOF_V1"

doc="docs/public/public-node-datanet-core-peer-pin-lane-closeout-capsule-v1.md"
handoff_doc="docs/public/public-node-datanet-core-peer-pin-orientation-stack-handoff-packet-v1.md"
handoff_proof="ops/mainnet0/datanet-core-peer-pin-orientation-stack-handoff-packet-v1-proof.sh"
...
echo "=== VOID DataNet Core Peer Pin Lane Closeout Capsule v1 Focused Proof ==="
echo "marker=$MARKER"
echo "head=$(git rev-parse --short HEAD)"

test -f "$doc"
test -f "$handoff_doc"
test -x "$handoff_proof"
test -f "$orientation_index_doc"
test -x "$orientation_index_proof"
test -x "$current_capsule_tool"

bash -n "$handoff_proof"
bash -n "$orientation_index_proof"
bash -n "$current_capsule_tool"

required_doc_lines=(
  'VOID_DATANET_CORE_PEER_PIN_LANE_CLOSEOUT_CAPSULE_DOC_V1'
...
grep -q 'VOID_DATANET_CORE_PEER_PIN_ORIENTATION_STACK_HANDOFF_PACKET_DOC_V1' "$handoff_doc"
grep -q 'VOID_DATANET_CORE_PEER_PIN_ORIENTATION_STACK_HANDOFF_PACKET_PROOF_V1_GREEN' "$handoff_proof"
grep -q 'orientation_stack_handoff_packet_terminal_safe=true' "$handoff_doc"
grep -q 'orientation_stack_handoff_packet_all_stack_cross_box_green=true' "$handoff_doc"
grep -q 'orientation_stack_handoff_packet_future_operator_safe=true' "$handoff_doc"
grep -q 'orientation_stack_handoff_packet_adds_authority=false' "$handoff_proof"
...
echo "datanet_core_peer_pin_lane_closeout_capsule_created_now=true"
echo "peer_pin_lane_closeout_capsule_terminal_safe=true"
echo "peer_pin_lane_closeout_capsule_lane_closed_now=true"
echo "peer_pin_lane_closeout_capsule_lane_closed_as_hold=true"
echo "peer_pin_lane_closeout_capsule_lane_safely_resumable=true"
echo "peer_pin_lane_closeout_capsule_requires_explicit_reopen=true"
echo "peer_pin_lane_closeout_capsule_safe_restart_point=docs/public/public-node-datanet-core-peer-pin-orientation-stack-handoff-packet-v1.md"
echo "peer_pin_lane_closeout_capsule_safe_orientation_index=docs/public/public-node-datanet-core-peer-pin-orientation-stack-index-v1.md"
echo "peer_pin_lane_closeout_capsule_safe_quick_command=ops/mainnet0/datanet-core-peer-pin-current-state-capsule-v1.sh"
echo "peer_pin_lane_closeout_capsule_current_head=92c299ef"
echo "peer_pin_lane_closeout_capsule_handoff_packet_head=92c299ef"
echo "peer_pin_lane_closeout_capsule_all_stack_cross_box_green=true"
echo "peer_pin_current_decision=continue_hold"
echo "peer_pin_lane_posture=closed_held_resumable"
...
echo "peer_pin_lane_closeout_capsule_adds_authority=false"
echo "peer_pin_lane_closeout_capsule_proof_scope=static_closeout_no_capsule_execution_no_smoke_receipt_execution_no_full_rollup_no_chain_execution"
echo "VOID_DATANET_CORE_PEER_PIN_LANE_CLOSEOUT_CAPSULE_PROOF_V1_GREEN"
