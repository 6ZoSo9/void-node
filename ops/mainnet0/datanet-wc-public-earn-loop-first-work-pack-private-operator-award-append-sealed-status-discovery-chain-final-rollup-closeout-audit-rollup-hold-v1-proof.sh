...
BRICK="datanet-wc-public-earn-loop-first-work-pack-private-operator-award-append-sealed-status-discovery-chain-final-rollup-closeout-audit-rollup-hold-v1"
MARKER="VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_PRIVATE_OPERATOR_AWARD_APPEND_SEALED_STATUS_DISCOVERY_CHAIN_FINAL_ROLLUP_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1"
...
PUBLIC_JSON="public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-chain-final-rollup-closeout-audit-rollup-hold-v1.json"
PUBLIC_HTML="public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-chain-final-rollup-closeout-audit-rollup-hold-v1.html"

FINAL_ROLLUP_HTML="public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-chain-final-rollup-hold-v1.html"
...
echo "== JSON parse / public discovery chain final rollup closeout binding =="

for f in "$DOC" "$INDEX_JSON" "$PUBLIC_JSON" "$PUBLIC_HTML" "$FINAL_ROLLUP_HTML" "$FINAL_ROLLUP_JSON" "$INDEX_PATCH_JSON"; do
...
assert(record.closeout_type === "award_append_private_operator_sealed_status_discovery_chain_final_rollup_closeout_audit_rollup", "closeout type mismatch");
...
assert(record.closeout.final_rollup_bound === true, "final rollup closeout binding mismatch");
...
assert(record.closeout.execution_state === "not_executed_by_this_public_final_rollup_closeout", "execution state mismatch");
assert(record.closeout.ledger_append_state === "not_appended_by_this_public_final_rollup_closeout", "ledger append state mismatch");
...
assert(html.includes("final rollup closeout"), "html closeout text missing");

console.log("public_discovery_chain_final_rollup_closeout_binding_green=true");
NODE
...
echo "== result =="
echo "VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_PRIVATE_OPERATOR_AWARD_APPEND_SEALED_STATUS_DISCOVERY_CHAIN_FINAL_ROLLUP_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1_GREEN"
