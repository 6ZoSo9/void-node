...
BRICK="datanet-wc-public-earn-loop-first-work-pack-private-operator-award-append-sealed-status-discovery-card-final-seal-hold-v1"
MARKER="VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_PRIVATE_OPERATOR_AWARD_APPEND_SEALED_STATUS_DISCOVERY_CARD_FINAL_SEAL_HOLD_V1"
DISCOVERY_CLOSEOUT_MARKER="VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_PRIVATE_OPERATOR_AWARD_APPEND_SEALED_STATUS_DISCOVERY_CARD_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1"
DISCOVERY_CARD_MARKER="VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_PRIVATE_OPERATOR_AWARD_APPEND_SEALED_STATUS_DISCOVERY_CARD_HOLD_V1"
...
PUBLIC_JSON="public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-card-final-seal-hold-v1.json"
PUBLIC_HTML="public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-card-final-seal-hold-v1.html"

echo "== JSON parse / public award append sealed status discovery final seal binding =="
...
for linked in \
  public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-card-closeout-audit-rollup-hold-v1.html \
  public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-card-closeout-audit-rollup-hold-v1.json \
  public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-card-hold-v1.html \
  public/public-node/work-credits/datanet-wc-first-work-pack-private-operator-award-append-sealed-status-discovery-card-hold-v1.json \
...
assert(record.seal_type === "award_append_private_operator_sealed_status_discovery_card_final_seal", "seal type mismatch");

assert(record.source.private_marker_values === "redacted_not_published", "private marker disclosure mismatch");
assert(record.public_chain.sealed_status_discovery_closeout_marker === "$DISCOVERY_CLOSEOUT_MARKER", "discovery closeout binding mismatch");
assert(record.public_chain.sealed_status_discovery_card_marker === "$DISCOVERY_CARD_MARKER", "discovery card binding mismatch");
...
assert(record.final_seal.discovery_closeout_bound === true, "discovery closeout final seal binding mismatch");
assert(record.final_seal.discovery_card_bound === true, "discovery card final seal binding mismatch");
assert(record.final_seal.sealed_status_final_seal_bound === true, "sealed status final seal binding mismatch");
assert(record.final_seal.sealed_status_closeout_bound === true, "sealed status closeout final seal binding mismatch");
assert(record.final_seal.sealed_status_rollup_bound === true, "sealed status rollup final seal binding mismatch");
...
assert(record.final_seal.seal_state === "discovery_card_final_seal_hold_for_public_review", "seal state mismatch");
assert(record.final_seal.execution_state === "not_executed_by_this_public_discovery_final_seal", "execution state mismatch");
assert(record.final_seal.ledger_append_state === "not_appended_by_this_public_discovery_final_seal", "ledger append state mismatch");
...
assert(html.includes("discovery final seal"), "html discovery final seal text missing");

console.log("public_award_append_sealed_status_discovery_final_seal_binding_green=true");
NODE
...
echo "== result =="
echo "VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_PRIVATE_OPERATOR_AWARD_APPEND_SEALED_STATUS_DISCOVERY_CARD_FINAL_SEAL_HOLD_V1_GREEN"
