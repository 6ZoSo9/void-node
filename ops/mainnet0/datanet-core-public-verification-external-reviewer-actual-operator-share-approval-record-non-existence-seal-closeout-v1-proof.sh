...
doc="docs/public/public-node-datanet-core-public-verification-external-reviewer-actual-operator-share-approval-record-non-existence-seal-closeout-v1.md"
pfx="datanet_core_public_verification_external_reviewer_actual_operator_share_approval_record_non_existence_seal_closeout_"

echo "marker=VOID_DATANET_CORE_PUBLIC_VERIFICATION_EXTERNAL_REVIEWER_ACTUAL_OPERATOR_SHARE_APPROVAL_RECORD_NON_EXISTENCE_SEAL_CLOSEOUT_PROOF_V1"
echo "head=$(git rev-parse --short HEAD)"

test -f "$doc"

grep -q 'VOID_DATANET_CORE_PUBLIC_VERIFICATION_EXTERNAL_REVIEWER_ACTUAL_OPERATOR_SHARE_APPROVAL_RECORD_NON_EXISTENCE_SEAL_CLOSEOUT_DOC_V1' "$doc"
...
for suffix in \
  ...
  static_only=true \
  base_head=056a844d \
  non_existence_seal_cross_box_green=true \
...
echo "VOID_DATANET_CORE_PUBLIC_VERIFICATION_EXTERNAL_REVIEWER_ACTUAL_OPERATOR_SHARE_APPROVAL_RECORD_NON_EXISTENCE_SEAL_CLOSEOUT_PROOF_V1_GREEN"
