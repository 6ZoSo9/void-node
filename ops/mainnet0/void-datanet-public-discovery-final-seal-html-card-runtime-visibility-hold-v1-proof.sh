...
BRICK="datanet-public-discovery-final-seal-html-card-runtime-visibility-hold-v1"
MARKER="VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1"
...
SOURCE_HTML_PATH="/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.html"
SOURCE_JSON_PATH="/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.json"
FINAL_SEAL_JSON_PATH="/public-node/datanet/datanet-public-discovery-final-seal-hold-v1.json"

SOURCE_HTML="public${SOURCE_HTML_PATH}"
SOURCE_JSON="public${SOURCE_JSON_PATH}"
FINAL_SEAL_JSON="public${FINAL_SEAL_JSON_PATH}"
SOURCE_MARKER="VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_HOLD_V1"
...
source_html = "/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.html"
source_json = "/public-node/datanet/datanet-public-discovery-final-seal-html-card-hold-v1.json"
final_seal_json = "/public-node/datanet/datanet-public-discovery-final-seal-hold-v1.json"
...
assert entry["scope"] == "datanet_public_discovery_final_seal_html_card_runtime_visibility"
...
assert card["schema"] == "void.public_node.datanet.public_discovery_final_seal_html_card_runtime_visibility.v1"
...
print("datanet_public_discovery_final_seal_html_card_runtime_visibility_binding_green=true")
PY
...
bash ops/mainnet0/void-datanet-public-discovery-final-seal-html-card-hold-v1-proof.sh >/tmp/void-datanet-final-seal-html-card-runtime-source-proof.log
grep -F "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_HOLD_V1_GREEN" /tmp/void-datanet-final-seal-html-card-runtime-source-proof.log >/dev/null
...
paths = [
    ...
    Path("public/public-node/datanet/datanet-public-discovery-final-seal-html-card-runtime-visibility-hold-v1.json"),
    Path("docs/public-node/datanet/datanet-public-discovery-final-seal-html-card-runtime-visibility-hold-v1.md"),
]
...
echo "== result =="
echo "VOID_DATANET_PUBLIC_DISCOVERY_FINAL_SEAL_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1_GREEN"
