...
BRICK="datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1"
MARKER="VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_HOLD_V1"
...
SOURCE="public/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-hold-v1.json"
...
brick = "datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1"
marker = "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_HOLD_V1"
source = "/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-hold-v1.json"
...
assert entry["scope"] == "datanet_wc_public_earn_status_reviewer_final_closeout_audit_rollup_html_card"
assert entry["html_card_only"] is True
assert entry["static_html_card_created"] is True
assert entry["source_final_closeout_audit_rollup"] == source
...
assert card["schema"] == "void.public_node.work_credits.datanet_wc_public_earn_status_reviewer_final_closeout_audit_rollup_html_card.v1"
...
assert card["source_final_closeout_audit_rollup"] == source
...
assert state["final_closeout_audit_rollup_source_present"] is True
...
source_card = json.loads(Path("public/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-hold-v1.json").read_text())
assert source_card["id"] == "datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-hold-v1"
assert source_card["marker"] == "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1"
assert source_card["wc_supply_unlimited_uncapped"] is True
assert source_card["wc_supply_lifetime_cap_declared"] is False
assert source_card["wc_boundary"]["public_submission_enabled"] is False
assert source_card["wc_boundary"]["accepts_work_packets"] is False
assert source_card["wc_boundary"]["issues_work_credits"] is False
assert source_card["wc_boundary"]["writes_wc_ledger"] is False
assert source_card["wc_boundary"]["transfers_void"] is False

print("wc_public_earn_status_reviewer_final_closeout_audit_rollup_html_card_binding_green=true")
PY

echo "== source proof stack =="
out=".runtime/mainnet0/${BRICK}.source-rollup-proof.log"
mkdir -p .runtime/mainnet0
bash ops/mainnet0/void-datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-hold-v1-proof.sh >"$out" 2>&1
grep -F "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1_GREEN" "$out" >/dev/null
...
echo "== result =="
echo "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_HOLD_V1_GREEN"
