...
grep -Fq "source_hash_chain_fixture_preview_length=4" "$SOURCE_HASH_CHAIN_FIXTURE_LOG"
...
echo "first_external_tester_wc_source_hash_chain_fixture_preview_length=4"
