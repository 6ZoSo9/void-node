...
echo "=== DataNet Published Retrieval Operator Approval Decision Boundary v1 rollup guard ==="
DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP="${TMPDIR:-/tmp}/void-datanet-published-retrieval-operator-approval-decision-boundary-live-rollup-$$"
mkdir -p "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP"

BASE="${BASE:-http://127.0.0.1:4100}" ops/mainnet0/public-node-datanet-published-retrieval-operator-approval-decision-boundary-v1-proof.sh \
  > "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"

grep -Fq 'VOID_DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_PROOF_V1_GREEN' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_review_packet_valid=true' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_approval_is_separate_operator_action=true' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_public_route_can_approve_candidate=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_operator_identity_bound_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_operator_approval_recorded_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_approval_signature_recorded_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_approval_timestamp_recorded_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_duplicate_guard_required_before_approval=true' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_duplicate_guard_performed_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_settlement_plane_required_before_award=true' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_settlement_plane_performed_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_automatic_award=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_award_intent_created_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_award_record_created_now=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_wc_delta_now=0' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_ledger_write=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_wc_credit_award=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_operator_approval_decision_boundary_public_mutation=false' "$DATANET_PUBLISHED_RETRIEVAL_OPERATOR_APPROVAL_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"

echo "datanet_published_retrieval_operator_approval_decision_boundary_live_status_rollup_green=true"
echo "datanet_published_retrieval_operator_approval_decision_boundary_review_packet_valid=true"
echo "datanet_published_retrieval_operator_approval_decision_boundary_approval_is_separate_operator_action=true"
echo "datanet_published_retrieval_operator_approval_decision_boundary_public_route_can_approve_candidate=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_operator_identity_bound_now=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_operator_approval_recorded_now=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_duplicate_guard_required_before_approval=true"
echo "datanet_published_retrieval_operator_approval_decision_boundary_duplicate_guard_performed_now=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_settlement_plane_required_before_award=true"
echo "datanet_published_retrieval_operator_approval_decision_boundary_settlement_plane_performed_now=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_automatic_award=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_award_intent_created_now=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_award_record_created_now=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_wc_delta_now=0"
echo "datanet_published_retrieval_operator_approval_decision_boundary_ledger_write=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_wc_credit_award=false"
echo "datanet_published_retrieval_operator_approval_decision_boundary_public_mutation=false"


echo "=== DataNet Published Retrieval Duplicate Guard Decision Boundary v1 rollup guard ==="
DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP="${TMPDIR:-/tmp}/void-datanet-published-retrieval-duplicate-guard-decision-boundary-live-rollup-$$"
mkdir -p "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP"

BASE="${BASE:-http://127.0.0.1:4100}" ops/mainnet0/public-node-datanet-published-retrieval-duplicate-guard-decision-boundary-v1-proof.sh \
  > "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"

grep -Fq 'VOID_DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_PROOF_V1_GREEN' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_review_packet_valid=true' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_guard_required=true' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_guard_performed_now=true' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_found=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_record_written_now=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_operator_approval_recorded_now=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_settlement_plane_required_before_award=true' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_settlement_plane_performed_now=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_automatic_award=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_award_intent_created_now=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_award_record_created_now=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_wc_delta_now=0' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_ledger_write=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_wc_credit_award=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"
grep -Fq 'datanet_published_retrieval_duplicate_guard_decision_boundary_public_mutation=false' "$DATANET_PUBLISHED_RETRIEVAL_DUPLICATE_GUARD_DECISION_BOUNDARY_ROLLUP_TMP/proof.log"

echo "datanet_published_retrieval_duplicate_guard_decision_boundary_live_status_rollup_green=true"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_review_packet_valid=true"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_guard_required=true"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_guard_performed_now=true"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_found=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_duplicate_record_written_now=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_operator_approval_recorded_now=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_settlement_plane_required_before_award=true"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_settlement_plane_performed_now=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_automatic_award=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_award_intent_created_now=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_award_record_created_now=false"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_wc_delta_now=0"
echo "datanet_published_retrieval_duplicate_guard_decision_boundary_ledger_write=false"
