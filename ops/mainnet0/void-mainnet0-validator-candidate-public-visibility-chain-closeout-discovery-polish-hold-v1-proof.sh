...
FINAL_SEAL_BRICK="mainnet0-validator-candidate-public-visibility-reviewer-final-seal-hold-v1"
FINAL_SEAL_MARKER="VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_REVIEWER_FINAL_SEAL_HOLD_V1"
...
FINAL_SEAL_JSON="public/public-node/validators/${FINAL_SEAL_BRICK}.json"
...
grep -F "$FINAL_SEAL_MARKER" "$FINAL_SEAL_JSON" >/dev/null
...
grep -F '"reviewer_final_seal_only": true' "$FINAL_SEAL_JSON" >/dev/null
...
expected = {
    ("/public-node/validators/mainnet0-validator-candidate-public-visibility-reviewer-final-seal-hold-v1.json", "VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_REVIEWER_FINAL_SEAL_HOLD_V1"),
    ("/public-node/validators/mainnet0-validator-candidate-public-visibility-reviewer-final-seal-html-card-hold-v1.html", "VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_REVIEWER_FINAL_SEAL_HTML_CARD_HOLD_V1"),
    ("/public-node/validators/mainnet0-validator-candidate-public-visibility-reviewer-final-seal-html-card-runtime-visibility-hold-v1.json", "VOID_MAINNET0_VALIDATOR_CANDIDATE_PUBLIC_VISIBILITY_REVIEWER_FINAL_SEAL_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1"),
...
sources = {(s["route"], s["marker"]) for s in card["source_records"]}
assert expected <= sources, sources
...
print("validator_candidate_public_visibility_chain_closeout_discovery_polish_binding_green=true")
PYCHECK
