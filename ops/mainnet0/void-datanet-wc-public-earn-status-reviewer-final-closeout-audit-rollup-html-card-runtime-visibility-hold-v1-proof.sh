...
BRICK="datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-runtime-visibility-hold-v1"
MARKER="VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1"

SOURCE_HTML_PATH="/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1.html"
SOURCE_JSON_PATH="/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1.json"
SOURCE_MARKER="VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_HOLD_V1"
...
brick = "datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-runtime-visibility-hold-v1"
marker = "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1"
source_html = "/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1.html"
source_json = "/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1.json"
...
assert "datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1" in entries
...
assert entry["scope"] == "datanet_wc_public_earn_status_reviewer_final_closeout_audit_rollup_html_card_runtime_visibility"
...
assert card["schema"] == "void.public_node.work_credits.datanet_wc_public_earn_status_reviewer_final_closeout_audit_rollup_html_card_runtime_visibility.v1"
...
source = json.loads(Path("public/public-node/work-credits/datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1.json").read_text())
assert source["id"] == "datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1"
assert source["marker"] == "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_HOLD_V1"
...
print("wc_public_earn_status_reviewer_final_closeout_audit_rollup_html_card_runtime_visibility_binding_green=true")
PY
...
bash ops/mainnet0/void-datanet-wc-public-earn-status-reviewer-final-closeout-audit-rollup-html-card-hold-v1-proof.sh >"$out" 2>&1
grep -F "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_HOLD_V1_GREEN" "$out" >/dev/null
...
echo "== result =="
echo "VOID_DATANET_WC_PUBLIC_EARN_STATUS_REVIEWER_FINAL_CLOSEOUT_AUDIT_ROLLUP_HTML_CARD_RUNTIME_VISIBILITY_HOLD_V1_GREEN"
