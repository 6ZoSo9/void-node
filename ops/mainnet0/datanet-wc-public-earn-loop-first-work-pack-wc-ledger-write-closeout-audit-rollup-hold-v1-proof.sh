...
BRICK="datanet-wc-public-earn-loop-first-work-pack-wc-ledger-write-closeout-audit-rollup-hold-v1"
MARKER="VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_WC_LEDGER_WRITE_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1"
KEY="datanet_wc_public_earn_loop_first_work_pack_wc_ledger_write_closeout_audit_rollup"
...
need(closeout["ledger_write_candidate_shape_exists"] is True, "candidate shape should exist")
need(closeout["ledger_write_candidate_example_exists"] is True, "candidate example should exist")
...
need(closeout["ledger_write_candidate_instantiated"] is False, "candidate instantiated must be false")
...
need(ledger["ledger_write_closeout_only"] is True, "ledger closeout only must be true")
...
print("wc_ledger_write_closeout_binding_green=true")
PY
...
echo "== result =="
echo "VOID_DATANET_WC_PUBLIC_EARN_LOOP_FIRST_WORK_PACK_WC_LEDGER_WRITE_CLOSEOUT_AUDIT_ROLLUP_HOLD_V1_GREEN"
