...
set +e
BASE="$BASE" SIZE_BYTES="$SIZE_BYTES" CHUNK_BYTES="$CHUNK_BYTES" ops/datanet/void-datanet-smoke-v5.sh >"$LOG" 2>&1
RC="$?"
set -e
...
# HELP void_datanet_not_mounted 1 if smoke indicates 404-on-PUT (routes missing or filtered).
