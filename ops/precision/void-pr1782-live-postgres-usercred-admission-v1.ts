...
console.log("VOID_PR1782_LIVE_POSTGRES_USERCRED_ADMISSION_V1");
console.log("production_credential_read=true");
...
assert.match(
  ...
  new RegExp(
    "^/run/user/" + String(uid) + "/credentials/[^/]+(?:\\.service)?$",
  ),
);
...
try {
  ...
  console.log("credentials_directory_systemd_user=true");
