...
grep -q 'current_baseline: 2eb6301c / ckpt-mainnet0-baseline-final-checklist-posture-green-20260523-022108' "$DOC"
...
grep -q 'current_baseline_pointer_commit: 152cf74c' "$GONOGO"
grep -q 'current_baseline_pointer_tag: ckpt-final-checklist-validator-candidate-posture-green-20260523-020915' "$GONOGO"
