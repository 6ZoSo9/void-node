...
grep -q 'current_operator_bootstrap_validators: 126' "$P"
grep -q 'next_operator_candidate: vault126' "$P"
grep -q 'next_operator_target_epoch: 128' "$P"
grep -q 'next_expected_validator_count: 127' "$P"
