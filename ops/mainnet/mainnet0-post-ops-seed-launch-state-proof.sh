...
VOID_ASSET_ADDR="0x470075B85352Eb86F7d089FB9ba88945f12AAd94"
...
VT_BAL="$(cast call --rpc-url "$RPC" "$VOID_ASSET_ADDR" 'balanceOf(address)(uint256)' "$VT" | awk '{print $1}')"
OT_BAL="$(cast call --rpc-url "$RPC" "$VOID_ASSET_ADDR" 'balanceOf(address)(uint256)' "$OT" | awk '{print $1}')"
