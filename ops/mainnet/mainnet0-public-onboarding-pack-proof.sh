...
grep -q "docs/public/mainnet0-current-public-status.md" "$ROOT_README"
grep -q "docs/public/void-network-whitepaper.md" "$ROOT_README"
grep -q "docs/public/mainnet0-public-release-bundle-closeout.md" "$ROOT_README"
