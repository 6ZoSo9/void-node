...
grep -q 'Final path remaining blockers baseline is cross-box proven at eac325a0 / ckpt-final-path-remaining-blockers-baseline-green-20260520-212306.' "$STATUS_FILE"
