...
grep -q 'Previous guarded operator vault125 live admission has executed and is reflected through epoch127; current next guarded operator lane is vault126 / epoch128 / expectedValidatorCount=127; public validator promotion/admission remains blocked.' "$STATUS_FILE"
