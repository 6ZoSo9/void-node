...
grep -q 'current_final_public_launch_checklist_baseline: ckpt-final-checklist-validator-candidate-posture-green-20260523-020915' "$DOC"
grep -q 'current_commit: 152cf74c' "$DOC"
...
grep -q 'current baseline + final go/no-go map refresh is cross-box proven at 152cf74c / ckpt-final-checklist-validator-candidate-posture-green-20260523-020915.' "$DOC"
grep -q 'current baseline pointer records 152cf74c / ckpt-final-checklist-validator-candidate-posture-green-20260523-020915.' "$DOC"
grep -q 'product surface, Settings UI, public validator candidate-only posture, and final checklist validator posture proof stack are green.' "$DOC"
