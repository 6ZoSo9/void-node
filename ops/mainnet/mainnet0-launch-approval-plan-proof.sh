...
grep -q 'current_final_public_launch_checklist_baseline: ckpt-settings-escape-close-green-20260522-120632' "$DOC"
grep -q 'current_commit: f8684313' "$DOC"
...
grep -q 'current baseline + final go/no-go map refresh is cross-box proven at f8684313 / ckpt-settings-escape-close-green-20260522-120632.' "$DOC"
grep -q 'current baseline pointer records f8684313 / ckpt-settings-escape-close-green-20260522-120632.' "$DOC"
grep -q 'product surface and Settings UI proof stack are green.' "$DOC"
