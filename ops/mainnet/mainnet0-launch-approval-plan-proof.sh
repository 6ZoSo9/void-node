...
grep -q 'product surface, Settings UI, public validator candidate-only posture, final checklist validator posture, and launch approval artifact prep proof stack are green.' "$DOC"
