...
grep -q 'current_final_public_launch_checklist_baseline: ckpt-launch-approval-artifact-prep-green-20260523-024355' "$DOC"
grep -q 'current_commit: 654ea54f' "$DOC"
...
grep -q 'current baseline + final go/no-go map refresh is cross-box proven at 654ea54f / ckpt-launch-approval-artifact-prep-green-20260523-024355.' "$DOC"
grep -q 'current baseline pointer records 654ea54f / ckpt-launch-approval-artifact-prep-green-20260523-024355.' "$DOC"
