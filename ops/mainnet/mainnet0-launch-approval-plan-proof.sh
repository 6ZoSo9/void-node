...
grep -q 'current_product_surface_datanet_baseline: ckpt-product-surface-datanet-goldenpath-green-20260522-075118' "$DOC"
grep -q 'current_commit: 5b279795' "$DOC"
...
grep -q 'current baseline + final go/no-go map refresh is cross-box proven at 5b279795 / ckpt-product-surface-datanet-goldenpath-green-20260522-075118.' "$DOC"
grep -q 'current baseline pointer records 5b279795 / ckpt-product-surface-datanet-goldenpath-green-20260522-075118.' "$DOC"
