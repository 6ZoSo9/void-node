...
grep -q 'current_final_public_launch_checklist_baseline: ckpt-current-baseline-candidate-only-posture-green-20260523-085213' "$DOC"
grep -q 'current_commit: 5a47a875' "$DOC"
...
grep -q 'current baseline + final go/no-go map refresh is cross-box proven at 5a47a875 / ckpt-current-baseline-candidate-only-posture-green-20260523-085213.' "$DOC"
grep -q 'current baseline pointer records 5a47a875 / ckpt-current-baseline-candidate-only-posture-green-20260523-085213.' "$DOC"
grep -q 'product surface, Settings UI, public validator candidate-only posture, final checklist validator posture, launch approval artifact prep, and launch approval artifact template proof stacks are green.' "$DOC"
