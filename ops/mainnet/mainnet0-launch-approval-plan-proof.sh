...
grep -q 'current_final_public_launch_checklist_baseline: ckpt-final-public-launch-checklist-product-baseline-green-20260522-084710' "$DOC"
grep -q 'current_commit: 56f9c2d2' "$DOC"
...
grep -q 'current baseline + final go/no-go map refresh is cross-box proven at 56f9c2d2 / ckpt-final-public-launch-checklist-product-baseline-green-20260522-084710.' "$DOC"
grep -q 'current baseline pointer records 56f9c2d2 / ckpt-final-public-launch-checklist-product-baseline-green-20260522-084710.' "$DOC"
