...
grep -q 'current_baseline_pointer_commit: 29e4c672' "$DOC"
grep -q 'current_baseline_pointer_tag: ckpt-current-baseline-summary-output-green-20260521-120111' "$DOC"
...
grep -q '^commit: 5d39ab41$' "$BASELINE"
grep -q '^tag: ckpt-final-path-wallet-doc-refresh-green-20260521-114305$' "$BASELINE"
