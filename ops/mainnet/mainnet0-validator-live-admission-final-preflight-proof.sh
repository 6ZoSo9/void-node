...
grep -Eq "ckpt-validator-live-admission|ckpt-validator-next-onboard-ready-wait|ckpt-validator-final-preflight|ckpt-validator-selector-vault125-readiness-refresh|ckpt-prelaunch-safety-noncoordinator-fallback|ckpt-prelaunch-safety-gonogo-fallback" "$OUT/git.describe.txt"
