...
grep -q 'Current baseline pointer now records 5b279795 / ckpt-product-surface-datanet-goldenpath-green-20260522-075118.' "$DOC"
...
grep -q 'Launch approval plan now records product surface/DataNet golden path as the current proven baseline.' "$DOC"
grep -q 'Product surface proof, DataNet tab proof, participant DataNet E2E proof, participant golden path proof, and remote product/network regression proof are green.' "$DOC"
