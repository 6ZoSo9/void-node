...
grep -q 'Launch approval plan current-baseline refresh is cross-box proven at e0fe2580 / ckpt-launch-approval-plan-current-baseline-green-20260521-220259.' "$DOC"
...
grep -q 'Final checklist proof sections restored is cross-box proven at 1b4ad771 / ckpt-final-checklist-proof-sections-restored-green-20260521-193346.' "$DOC"
grep -q 'Launch approval plan now points to 5efd1adf / ckpt-current-baseline-final-checklist-closeout-green-20260521-211057.' "$DOC"
grep -q 'Launch approval plan records current baseline pointer cc8a4f4a / ckpt-final-checklist-sections-closeout-doc-green-20260521-195012.' "$DOC"
grep -q 'This supersedes fdfa1af5 / ckpt-final-checklist-gonogo-fallback-green-20260521-193000 because that checkpoint weakened the embedded checklist proof.' "$DOC"
