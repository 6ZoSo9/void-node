...
bash ops/two-box-datanet-provenance-diff.sh | tee "$OUT/provenance-diff-before.txt"
...
APPLY=1 LIMIT="$LIMIT" WHO="$WHO" bash ops/two-box-datanet-materialize-from-peer.sh | tee "$OUT/materialize.txt"
...
bash ops/two-box-datanet-provenance-diff.sh | tee "$OUT/provenance-diff-after.txt"
