...
manifest_days_val="$(query_scalar 'max(void_mainnet_core_manifest_days or chosen_manifest_days or void_mainnet_core_manifest_days)')"
chosen_days_val="$(query_scalar 'void_mainnet_core_manifest_days')"
...
print_line "max(void_mainnet_core_manifest_days or chosen_manifest_days or void_mainnet_core_manifest_days)"  "${manifest_days_val}"
print_line "void_mainnet_core_manifest_days"             "${chosen_days_val}"
...
if [ "${manifest_days_warn}" = "1" ]; then
  echo "[pillars] WARN: manifest_days/ void_mainnet_core_manifest_days missing; trusting manifest_health=1 for manifest_ok" >&2
fi
