...
needles=(
  ...
  'Buy VOID'
  'Preview Staking'
  'guided participant-page request flow'
  'Candidate/waiting preview only; active admission disabled.'
  'VOID_HOME_MAINNET0_PUBLIC_LIVE_CLARITY_V1'
  'Start with Wallet'
  'Buy VOID must use the guided request flow'
  'validator registration is candidate/waiting only'
  'active admission stays disabled unless a later guarded proof lane changes it'
