...
contract MockVoidTokenEpochCommitmentRegistryProof {
...
contract ValidatorHelperEpochCommitmentRegistry {
    function approveToken(address token, address spender, uint256 amount) external {
        MockVoidTokenEpochCommitmentRegistryProof(token).approve(spender, amount);
    }
...
contract ValidatorEpochCommitmentRegistryLocalProof is Script {
    struct Env {
        MockVoidTokenEpochCommitmentRegistryProof token;
        ...
        ValidatorHelperEpochCommitmentRegistry h1;
        ValidatorHelperEpochCommitmentRegistry h2;
        ValidatorHelperEpochCommitmentRegistry h3;
    }

    function _deploy(address admin) internal returns (Env memory e) {
        e.token = new MockVoidTokenEpochCommitmentRegistryProof();
        ...
        e.h1 = new ValidatorHelperEpochCommitmentRegistry();
        e.h2 = new ValidatorHelperEpochCommitmentRegistry();
        e.h3 = new ValidatorHelperEpochCommitmentRegistry();
    }
    ...
    function run() external {
        ...
        ValidatorEpochCommitmentRegistry.PublishedEpochCommitment memory p1 = e.commitmentRegistry.readPublished(1);
        ValidatorEpochCommitmentRegistry.PublishedEpochCommitment memory p2 = e.commitmentRegistry.readPublished(2);

        console2.log("=== published epoch 1 ===");
        console2.log("startSlot", p1.startSlot);
        console2.log("endSlotExclusive", p1.endSlotExclusive);
        console2.logBytes32(p1.validatorSetCommitment);
        console2.logBytes32(p1.scheduleWindowCommitment);
        console2.logBytes32(p1.epochWindowCommitment);
        console2.log("match", e.commitmentRegistry.isPublishedMatch(1));

        console2.log("=== published epoch 2 ===");
        console2.log("startSlot", p2.startSlot);
        console2.log("endSlotExclusive", p2.endSlotExclusive);
        console2.logBytes32(p2.validatorSetCommitment);
        console2.logBytes32(p2.scheduleWindowCommitment);
        console2.logBytes32(p2.epochWindowCommitment);
        console2.log("match", e.commitmentRegistry.isPublishedMatch(2));
