...
RUNTIME_MARKER="VOID_DATANET_FIELD_REPLICATION_REAL_TWO_BOX_BOUNDED_PUBLIC_SUMMARY_TERMINAL_FINAL_SEAL_RUNTIME_V1_GREEN"

bash tools/check_datanet_field_replication_real_two_box_bounded_public_summary_terminal_final_seal_v1.sh
...
LOG="/tmp/void-datanet-terminal-final-seal-runtime-${PORT}.log"
PID_FILE="/tmp/void-datanet-terminal-final-seal-runtime-${PORT}.pid"
...
JSON_URL="${BASE}/public-node/datanet/field-replication-real-two-box-bounded-public-summary-terminal-final-seal-v1.json"
HTML_URL="${BASE}/public-node/datanet/field-replication-real-two-box-bounded-public-summary-terminal-final-seal-v1.html"
INDEX_URL="${BASE}/public-node/datanet/index.json"

JSON_OUT="/tmp/void-datanet-terminal-final-seal-runtime-${PORT}.json"
HTML_OUT="/tmp/void-datanet-terminal-final-seal-runtime-${PORT}.html"
INDEX_OUT="/tmp/void-datanet-terminal-final-seal-runtime-${PORT}-index.json"
...
assert idx["stable_npm_alias"] == "npm run datanet:field-replication:real-two-box-closeout-smoke"
...
print("runtime terminal final seal fetch ok")
