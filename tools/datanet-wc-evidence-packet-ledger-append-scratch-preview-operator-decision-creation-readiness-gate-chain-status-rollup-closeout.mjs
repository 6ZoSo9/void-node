...
const LANE = 'datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-chain-status-rollup-closeout';
const MARKER = 'VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_CREATION_READINESS_GATE_CHAIN_STATUS_ROLLUP_CLOSEOUT_HOLD_V1';

const SOURCE_LANE = 'datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-chain-status-rollup';
const SOURCE_MARKER = 'VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_CREATION_READINESS_GATE_CHAIN_STATUS_ROLLUP_HOLD_V1';
const SOURCE_HEAD = 'c918314e';
const SOURCE_TAG = 'ckpt-datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-chain-status-rollup-hold-v1-post-merge-exact-green-20260703-124005';

const SOURCES = [
  {
    role: 'source_readiness_gate_chain_status_rollup_doc',
    path: `docs/datanet/${SOURCE_LANE}-hold-v1.md`,
    required_marker: SOURCE_MARKER
  },
  {
    role: 'source_readiness_gate_chain_status_rollup_proof',
    path: `ops/mainnet0/${SOURCE_LANE}-hold-v1-proof.sh`,
    required_marker: SOURCE_MARKER
  },
  {
    role: 'source_readiness_gate_chain_status_rollup_tool',
...
const artifact = {
  ...
  version: 'hold-v1',
  marker: MARKER,
  status: 'read_only_operator_decision_creation_readiness_gate_chain_status_rollup_closeout_ready',
  source_chain: {
  ...
  closeout_scope: {
    closes: 'operator decision creation readiness gate chain status rollup',
    purpose: 'close out the read-only chain status rollup before any future operator decision candidate creation packet lane',
    authority: 'read_only_closeout_only'
  },
  chain_status_rollup_closeout: {
