...
const LANE = 'datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-closeout';
const MARKER = 'VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_CREATION_READINESS_GATE_CLOSEOUT_HOLD_V1';

const SOURCE_LANE = 'datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate';
const SOURCE_MARKER = 'VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_CREATION_READINESS_GATE_HOLD_V1';
const SOURCE_HEAD = '67c191aa';
const SOURCE_TAG = 'ckpt-datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-hold-v1-post-merge-exact-green-20260703-120640';

const SOURCES = [
  {
    role: 'source_readiness_gate_doc',
    path: `docs/datanet/${SOURCE_LANE}-hold-v1.md`,
    required_marker: SOURCE_MARKER
  },
  {
    role: 'source_readiness_gate_proof',
    path: `ops/mainnet0/${SOURCE_LANE}-hold-v1-proof.sh`,
    required_marker: SOURCE_MARKER
  },
  {
    role: 'source_readiness_gate_tool',
...
const artifact = {
  ...
  version: 'hold-v1',
  marker: MARKER,
  status: 'read_only_operator_decision_creation_readiness_gate_closeout_ready',
  source_chain: {
  ...
  closeout_scope: {
    closes: 'operator decision creation readiness gate',
    purpose: 'close out the read-only readiness gate before any future operator decision candidate creation packet lane',
    authority: 'read_only_closeout_only'
  },
  readiness_gate_closeout: {
