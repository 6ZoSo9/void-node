...
const LANE = 'datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-chain-status-rollup';
const MARKER = 'VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_CREATION_READINESS_GATE_CHAIN_STATUS_ROLLUP_HOLD_V1';

const SOURCE_LANE = 'datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-closeout-final-seal-index-closeout';
const SOURCE_MARKER = 'VOID_DATANET_WC_EVIDENCE_PACKET_LEDGER_APPEND_SCRATCH_PREVIEW_OPERATOR_DECISION_CREATION_READINESS_GATE_CLOSEOUT_FINAL_SEAL_INDEX_CLOSEOUT_HOLD_V1';
const SOURCE_HEAD = '956fee9e';
const SOURCE_TAG = 'ckpt-datanet-wc-evidence-packet-ledger-append-scratch-preview-operator-decision-creation-readiness-gate-closeout-final-seal-index-closeout-hold-v1-post-merge-exact-green-20260703-123540';

const SOURCES = [
  {
    role: 'source_readiness_gate_terminal_closeout_doc',
    path: `docs/datanet/${SOURCE_LANE}-hold-v1.md`,
    required_marker: SOURCE_MARKER
  },
  {
    role: 'source_readiness_gate_terminal_closeout_proof',
    path: `ops/mainnet0/${SOURCE_LANE}-hold-v1-proof.sh`,
    required_marker: SOURCE_MARKER
  },
  {
    role: 'source_readiness_gate_terminal_closeout_tool',
...
const artifact = {
  ...
  version: 'hold-v1',
  marker: MARKER,
  status: 'read_only_operator_decision_creation_readiness_gate_chain_status_rollup_ready',
  source_chain: {
...
const payload = {
  ...
  artifact,
  rollup_hash: hashCanonical(artifact)
};
