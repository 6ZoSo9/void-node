...
marker="VOID_PUBLIC_NODE_OPERATOR_TRIAL_TESTER_LAUNCH_TERMINAL_CLOSEOUT_ROLLUP_V1"
green="VOID_PUBLIC_NODE_OPERATOR_TRIAL_TESTER_LAUNCH_TERMINAL_CLOSEOUT_ROLLUP_V1_GREEN"

json="public/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.json"
html="public/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.html"
doc="docs/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.md"
...
rollup = json.loads(Path("public/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.json").read_text())
...
assert rollup["status"] == "tester_launch_terminal_closeout_rollup_ready"
assert rollup["public_safe"] is True
assert rollup["read_only"] is True
assert rollup["boundary"]["terminal_closeout_rollup_only"] is True
...
required = [
    ...
    "trial_terminal_final_seal"
]
assert [item["key"] for item in rollup["sealed_components"]] == required

status = rollup["closeout_status"]
assert status["tester_launch_terminal_final_sealed"] is True
assert status["tester_launch_terminal_closeout_rollup_ready"] is True
...
entry = index["public_node_operator_trial_tester_launch_terminal_closeout_rollup"]
assert entry["marker"] == marker
assert entry["expected_green_marker"] == green
assert entry["status"] == "tester_launch_terminal_closeout_rollup_ready"
assert entry["html"] == "/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.html"
assert entry["json"] == "/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.json"

assert index["links"]["public_node_operator_trial_tester_launch_terminal_closeout_rollup"] == "/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.html"
assert index["links"]["public_node_operator_trial_tester_launch_terminal_closeout_rollup_json"] == "/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.json"
assert index["route_markers"]["public_node_operator_trial_tester_launch_terminal_closeout_rollup"] == marker
...
for key in [
    ...
    assert index[key]["tester_launch_terminal_closeout_rollup_ready"] is True, key
...
assert has_route("/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.html")
assert has_route("/public-node/public-node-operator-trial-tester-launch-terminal-closeout-rollup-v1.json")

print("trial tester launch terminal closeout rollup/index assertions passed")
PY
