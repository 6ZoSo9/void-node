...
export function deriveBtcVoidTradeFundedFeesV1(raw) {
  ...
  const result = {
    ...
    launch_fee_topology_gate: {
      ...
      executable_reservation_ttl_required: true,
      per_identity_outstanding_reservation_cap_required: true,
      global_outstanding_reservation_cap_required: true,
      expired_reservation_has_no_settlement_authority: true,
      late_funding_after_reservation_expiry_requires_reconciliation: true,
      executable_reservation_hoarding_protection_proven: false,
      zero_protocol_btc_seed_requires_opening_discovery: true,
      opening_reserve_snapshot_must_derive_from_verified_discovery: true,
      opening_quote_reserve_provenance_required: true,
      opening_concentration_and_sybil_protection_required: true,
      opening_minimum_real_btc_depth_policy_required: true,
      opening_price_discovery_authority_proven: false,
      protocol_fee_and_buyback_spread_are_distinct: true,
      combined_protocol_fee_and_buyback_spread_policy_review_required: true,
      combined_protocol_fee_and_buyback_spread_policy_reviewed: false,
      complete_public_fee_component_disclosure_required: true,
      complete_public_fee_component_disclosure_proven: false,
      net_user_output_and_quote_expiry_disclosure_required: true,
    ...
    executable_invariants: {
      ...
      quote_not_executable_until_reservation_hoarding_protection_ready: true,
      quote_not_executable_until_opening_price_discovery_ready: true,
      quote_not_executable_until_combined_fee_policy_reviewed: true,
      quote_not_executable_until_fee_disclosure_ready: true,
