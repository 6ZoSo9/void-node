...
marker="VOID_PUBLIC_NODE_OPERATOR_TRIAL_TESTER_LAUNCH_CHECKLIST_CLOSEOUT_ROLLUP_V1"
green="VOID_PUBLIC_NODE_OPERATOR_TRIAL_TESTER_LAUNCH_CHECKLIST_CLOSEOUT_ROLLUP_V1_GREEN"

json="public/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.json"
html="public/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.html"
doc="docs/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.md"
...
rollup = json.loads(Path("public/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.json").read_text())
...
assert rollup["status"] == "tester_launch_checklist_closeout_rollup_ready"
assert rollup["public_safe"] is True
assert rollup["read_only"] is True
assert rollup["boundary"]["closeout_rollup_only"] is True
assert rollup["boundary"]["checklist_closeout_only"] is True
...
required = [
    ...
    "tester_kit_public_entrypoint_link_closeout",
...
assert status["tester_launch_checklist_closeout_rollup_ready"] is True
...
entry = index["public_node_operator_trial_tester_launch_checklist_closeout_rollup"]
assert entry["marker"] == marker
assert entry["expected_green_marker"] == green
assert entry["status"] == "tester_launch_checklist_closeout_rollup_ready"
assert entry["html"] == "/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.html"
assert entry["json"] == "/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.json"

assert index["links"]["public_node_operator_trial_tester_launch_checklist_closeout_rollup"] == "/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.html"
assert index["links"]["public_node_operator_trial_tester_launch_checklist_closeout_rollup_json"] == "/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.json"
assert index["route_markers"]["public_node_operator_trial_tester_launch_checklist_closeout_rollup"] == marker
...
for key in [
    ...
    assert index[key]["tester_launch_checklist_closeout_rollup_ready"] is True, key
...
assert has_route("/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.html")
assert has_route("/public-node/public-node-operator-trial-tester-launch-checklist-closeout-rollup-v1.json")

print("trial tester launch checklist closeout rollup/index assertions passed")
PY
