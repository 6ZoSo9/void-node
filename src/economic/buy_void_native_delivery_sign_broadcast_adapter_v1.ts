...
export const VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_ADAPTER_V1 =
  "VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_ADAPTER_V1";

export const VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_CONFIRMATION_V1 =
  "buyVoidNativeSignAndBroadcast";

export const VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_AUTHORITY_V1 = {
...
export const VOID_BUY_VOID_NATIVE_DELIVERY_UNIT_SCALE_V1 = {
...
export type BuyVoidNativeDeliverySignBroadcastPolicyV1 = {
  enabled: boolean;
...
export type BuyVoidNativeDeliveryTransactionPlanV1 = {
  chain_id: string | number;
  nonce: string | number;
...
export type BuyVoidNativeDeliveryUnsignedTransactionV1 = {
  type: 2;
  chainId: bigint;
  nonce: number;
  gasLimit: bigint;
...
export type BuyVoidNativeDeliverySubmissionBindingV1 = {
  marker: typeof VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_ADAPTER_V1;
...
export type BuyVoidNativeDeliverySubmissionGuardV1 = {
  claim_submission_once: (
    binding: Readonly<BuyVoidNativeDeliverySubmissionBindingV1>,
  ) => Promise<
    | { claimed: true }
    | {
        claimed: false;
...
export type BuyVoidNativeDeliverySignerV1 = {
...
export type BuyVoidNativeDeliveryBroadcastResultV1 = {
  accepted: boolean;
...
export type BuyVoidNativeDeliveryBroadcasterV1 = {
  broadcast_signed_transaction: (
    raw_signed_transaction: string,
  ) => Promise<BuyVoidNativeDeliveryBroadcastResultV1>;
};

export type BuyVoidNativeDeliverySignBroadcastDependenciesV1 = {
  submission_guard: BuyVoidNativeDeliverySubmissionGuardV1;
  signer: BuyVoidNativeDeliverySignerV1;
  broadcaster: BuyVoidNativeDeliveryBroadcasterV1;
};

export type BuyVoidNativeDeliverySignBroadcastInputV1 = {
  apply?: boolean;
  ...
  plan: BuyVoidNativeDeliveryTransactionPlanV1;
  dependencies?: BuyVoidNativeDeliverySignBroadcastDependenciesV1;
};

export type BuyVoidNativeDeliverySignBroadcastReadyV1 = {
  ok: true;
  marker: typeof VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_ADAPTER_V1;
  version: 1;
  ...
  expected_transaction_hash: string;
  transaction_plan_fingerprint_sha256: string;
  transaction_plan: BuyVoidNativeDeliveryUnsignedTransactionV1;
...
export type BuyVoidNativeDeliverySignBroadcastHeldV1 = {
  ok: false;
  marker: typeof VOID_BUY_VOID_NATIVE_DELIVERY_SIGN_BROADCAST_ADAPTER_V1;
  version: 1;
...
export type BuyVoidNativeDeliverySignBroadcastDecisionV1 =
  | BuyVoidNativeDeliverySignBroadcastReadyV1
...
async function releaseClaimForDefinitiveNotBroadcast(
  ...
  normalized: NormalizedV1,
  dependencies: BuyVoidNativeDeliverySignBroadcastDependenciesV1,
  binding: BuyVoidNativeDeliverySubmissionBindingV1,
  options: Partial<BuyVoidNativeDeliverySignBroadcastHeldV1> = {},
): Promise<BuyVoidNativeDeliverySignBroadcastHeldV1> {
  let release:
    | { released: true }
...
export async function runBuyVoidNativeDeliverySignBroadcastV1(
  input: BuyVoidNativeDeliverySignBroadcastInputV1,
): Promise<BuyVoidNativeDeliverySignBroadcastDecisionV1> {
  ...
  let claim: Awaited<
    ReturnType<BuyVoidNativeDeliverySubmissionGuardV1["claim_submission_once"]>
  >;
  try {
  ...
  try {
    ...
    let broadcast: BuyVoidNativeDeliveryBroadcastResultV1;
    try {
