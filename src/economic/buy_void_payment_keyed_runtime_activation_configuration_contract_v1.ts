...
export const
  VOID_BUY_VOID_PAYMENT_KEYED_RUNTIME_ACTIVATION_CONFIGURATION_V1 = {
    ...
    prerequisite_source_truth: {
      ...
      known_anvil_prefunded_dev_accounts_must_be_neutralized: true,
      known_anvil_dev_private_key_transactions_must_be_rejected: true,
      native_gas_genesis_supply_and_known_key_accounts_must_be_reconciled: true,
      private_evm_selector_durability_must_be_deployed: true,
      durable_checkpoint_must_cover_latest_accepted_economic_mutation: true,
      restart_from_latest_durable_checkpoint_must_be_proven: true,
      stale_private_evm_state_fallback_must_be_impossible: true,
      economic_mutation_durability_gate_must_be_active_before_public_money: true,
      ...
      unpaid_instruction_reservation_ttl_required: true,
      per_identity_outstanding_instruction_cap_required: true,
      global_outstanding_instruction_cap_required: true,
      expired_unpaid_instruction_releases_soft_reservation_only_after_payment_absence_recheck: true,
      late_payment_after_instruction_expiry_requires_deterministic_reconciliation: true,
      expired_instruction_must_not_auto_fulfill_or_auto_refund: true,
      public_fee_component_disclosure_required_before_payment_authority: true,
      public_gross_and_net_amount_disclosure_required: true,
      public_source_chain_gas_payer_disclosure_required: true,
      public_chain2050_gas_payer_model_disclosure_required: true,
      public_instruction_expiry_and_late_payment_disclosure_required: true,
      hidden_fee_or_hidden_deduction_forbidden: true,
    ...
    unpaid_instruction_reservation_hoarding_protection_ready: false,
    payment_instruction_ttl_policy_ready: false,
    late_payment_after_instruction_expiry_reconciliation_ready: false,
    public_fee_and_gas_disclosure_ready: false,
    ...
    activation_preconditions: {
      ...
      known_anvil_prefunded_dev_accounts_neutralized_before_public_activation: true,
      known_anvil_dev_private_key_submission_blocked_before_public_activation: true,
      native_gas_genesis_supply_and_known_key_accounts_reconciled_before_public_activation: true,
      private_evm_selector_durability_deployed_before_public_activation: true,
      latest_durable_checkpoint_covers_latest_accepted_economic_mutation: true,
      private_evm_restart_recovery_proven_before_public_activation: true,
      private_evm_stale_state_fallback_impossible_before_public_activation: true,
      economic_mutation_durability_gate_active_before_public_money: true,
      ...
      unpaid_instruction_reservation_ttl_required_before_public_payment_instructions: true,
      per_identity_and_global_outstanding_instruction_caps_required: true,
      late_payment_after_expiry_reconciliation_required: true,
      automatic_fulfillment_or_refund_after_expired_instruction_forbidden: true,
      complete_fee_gas_net_amount_and_expiry_disclosure_required_before_payment_authority: true,
      hidden_fee_or_hidden_deduction_forbidden: true,
